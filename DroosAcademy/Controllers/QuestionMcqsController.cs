...
namespace DroosAcademy.Controllers
{
    ...
    public class QuestionMcqsController : ControllerBase
    {
        ...
        public async Task<ActionResult<QuestionMcq>> PostQuestionMcq(QuestionMcq questionMcq)
        {
            ...
            await _context.SaveChangesAsync();
            var answers = await _context.QuestionMcqs.OrderBy(e => e.Id).LastOrDefaultAsync(e => e.Orders == questionMcq.Orders && e.Answer == questionMcq.Answer && e.QuestionId == questionMcq.QuestionId);
            Response r = new Response();
